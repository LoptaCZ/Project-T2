...
public class FXDrip extends TextureSheetParticle {
    protected FXDrip(ClientLevel level, double x, double y, double z, SpriteSet sprites){
        super(level,x,y,z);
        this.setSpriteFromAge(sprites);
    }
    public FXDrip(Level level, double x, double y, double z, double dirX, double dirY, double dirZ, SpriteSet sprites){
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType type, @NotNull ClientLevel level, double x, double y, double z, double dx, double dy, double dz){
            return new FXDrip(level,x,y,z,dx,dy,dz,sprites);
        }
    }
}
